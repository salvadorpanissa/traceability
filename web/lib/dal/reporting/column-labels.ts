...
const COLUMN_LABELS: Record<string, Record<Locale, string>> = {
  ...
  current_establishment_id: { es: "Campo" },
  establishment_id: { es: "Campo" },
  establishment_name: { es: "Campo" },
  origin_establishment_id: { es: "Campo origen" },
  origin_establishment_name: { es: "Campo origen" },
  destination_establishment_id: { es: "Campo destino" },
  destination_establishment_name: { es: "Campo destino" },
