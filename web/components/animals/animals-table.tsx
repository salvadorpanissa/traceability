...
export function AnimalsTable({ rows, locale }: { rows: AnimalLookupDetail[]; locale: Locale }) {
  const columns: DataTableColumn<AnimalLookupDetail>[] = [
    ...
    },
    {
      ...
      exportValue: (row) => row.categoryName ?? translate(locale, "livestock.noCategory"),
      width: "w-32",
    },
    {
      key: "establishment",
      ...
      exportValue: (row) => row.establishmentName ?? translate(locale, "livestock.noEstablishment"),
      width: "w-32",
    },
    {
      key: "paddock",
      ...
      exportValue: (row) => row.paddockName ?? translate(locale, "livestock.noPaddock"),
      width: "w-32",
    },
    {
      key: "status",
      ...
      exportValue: (row) => statusLabel(row.status, locale),
      width: "w-24",
    },
    {
      key: "sex",
      ...
      exportValue: (row) => sexLabel(row.sex, locale),
      width: "w-20",
    },
    {
      key: "breed",
    ...
    },
    {
      ...
      exportValue: (row) => row.reproductiveStatusName ?? translate(locale, "animalLookup.noReproductiveStatus"),
      width: "w-32",
    },
    {
      key: "owner",
